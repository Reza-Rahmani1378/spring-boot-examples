package com.hami.sqlspringboot.sql.service.date_time_mapper;
...
public class CalendarTool {
    ...
    public String getIranianDateWithDelimiter(String delimiter) {
        return (irYear + delimiter + String.format("%02d", irMonth) + delimiter + String.format("%02d", irDay));
    }
